...
- we dont knoww what is exactly changing; we can say data from higher peak is going to lower peak but we are still unsure af 
...
- but each point was being created by the average of millions of students 
- we have a lack of time(years) for this data but we dont have a lack of time
...
CASE STUDY: USA 
- find a source to talk about whether the transition from diff modalities is 
...
-- ADD AARYAS GDP AND SPENDING PLOT HERE

add - spending vs pisa 
